...
<body>
    ...
    <nav class="sidebar">
        ...
        <a href="#" class="nav-link active" onclick="switchTab('agenda')"><i class="fa-regular fa-calendar-days"></i>Mi Agenda</a>
        <a href="#" class="nav-link" onclick="switchTab('services')"><i class="fa-solid fa-list-check"></i> Mis Servicios</a>
        <a href="#" class="nav-link" onclick="switchTab('products')"><i class="fa-solid fa-box-open"></i> Mis Productos</a>
        <a href="/" class="nav-link logout-mt"><i class="fa-solid fa-arrow-right-from-bracket"></i> Cerrar sesión</a>
    </nav>
    ...
    <main class="main-content">
        ...
        <section id="agenda" class="content-section active">
            <div class="row g-4 mb-5">
                <div class="col-md-6">
                    <div class="stat-card">
                        <div class="stat-info"><h3>5</h3><p>Citas de hoy</p></div>
                        <div class="stat-icon"><i class="fa-solid fa-clock"></i></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="stat-card">
                        <div class="stat-info"><h3>2</h3><p>Solicitudes Pendientes</p></div>
